                                ...
                                if($task !== NULL):
                                    ...
                                    foreach ($task as $item):
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center text-break" style="max-width: 56px;"><?php echo $item['Titulo']; ?></td>
                                            <td class="text-center text-break" style="max-width: 56px;"><?php echo $item['Descricao']; ?></td>
                                            <td class="text-center text-break" style="max-width: 56px;">
